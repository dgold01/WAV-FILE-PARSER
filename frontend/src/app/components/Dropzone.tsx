...
import { extractWavInfo } from '../../fileAnalysis/fileAnalysis'
...
export default function DropZone() {
        ...
        async function getFileInfo() {
            ...
            try {
                if (fileList) {
                    ...
                    console.log(file)
                    const { sampleRate, channels, byteRate, chunkSize, audioFormat, bitsPerSample, blockAlign, subChunkID, chunkID,format } = await extractWavInfo(file)
    ...
    function convertChunkID(chunkID : any) {
        var string = '';
        for (var i = 0; i < 4; i++) {
            var byte = (chunkID >> (i * 8)) & 0xFF;
